var HeaderVideo = (function ($, document) {
    ...
    var settings = {
        ...
        autoPlayVideo: false,
        hdnBundelVersion: $("#hdnBundelVersion")
    }
    ...
    var appendTeaserVideo = function () {
        if (Modernizr.video) {
            ...
            html = '<video autoplay="true" loop="loop" muted id="teaser-video" class="teaser-video"><source src="' + source + '.mp4' + settings.hdnBundelVersion.val() + '" type="video/mp4"><source src="' + source + '.ogv' + settings.hdnBundelVersion.val() + '" type="video/ogg"></video>';
    ...
    var createFrame = function () {
        ...
        if (videoDetails.provider === 'youtube') {
            ...
            var html = '<video autoplay="true" loop="loop" id="video"><source src="' + videoDetails.id + '.mp4' + settings.hdnBundelVersion.val() + '" type="video/mp4"><source src="' + videoDetails.id + '.ogv' + settings.hdnBundelVersion.val() + '" type="video/ogg"></video>';
        }
        return html;
    };
