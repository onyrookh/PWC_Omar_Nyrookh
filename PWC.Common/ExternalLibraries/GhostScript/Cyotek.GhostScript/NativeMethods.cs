...
namespace Cyotek.GhostScript
{
  ...
  #region  Public Class Methods  
    ...
    [DllImport("C:\\Program Files (x86)\\gs\\gs9.15\\bin\\gsdll64.dll", EntryPoint = "gsapi_delete_instance")]
    public static extern void gsapi_delete_instance(IntPtr instance);

    // int gsapi_exit (void *instance);
    [DllImport("C:\\Program Files (x86)\\gs\\gs9.15\\bin\\gsdll64.dll", EntryPoint = "gsapi_exit")]
    ...
    [DllImport("C:\\Program Files (x86)\\gs\\gs9.15\\bin\\gsdll64.dll", EntryPoint = "gsapi_init_with_args")]
    ...
    [DllImport("C:\\Program Files (x86)\\gs\\gs9.15\\bin\\gsdll64.dll", EntryPoint = "gsapi_new_instance")]
    ...
    [DllImport("C:\\Program Files (x86)\\gs\\gs9.15\\bin\\gsdll64.dll", EntryPoint = "gsapi_revision")]
    ...
    [DllImport("C:\\Program Files (x86)\\gs\\gs9.15\\bin\\gsdll64.dll", EntryPoint = "gsapi_run_file")]
    ...
    [DllImport("C:\\Program Files (x86)\\gs\\gs9.15\\bin\\gsdll64.dll", EntryPoint = "gsapi_set_stdio")]
